...
function App() {
  ...
  const handleInput = () => {
    ...
    if (words9.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "The owner of this bot is Rajesha T";
        inputRef.value = ""; // clear the input
      }, 2000);
    }

    let owner2 = [
      "Who's Rajesha T|who's Rajesha T|Who is Rajesha T|who is Rajesha T|who is rajesha t|who is rajesha|who is rajesh|Who is rajesh",
    ];
    let words10 = new RegExp(owner2);
    if (words10.test(document.querySelector("#input").value)) {
      getBotMessage.innerText = "Typing...";
      setTimeout(() => {
        getBotMessage.innerText = "Rajesh is a programmer based on ReactJS";
        inputRef.value = ""; // clear the input
      }, 2000);
    }
